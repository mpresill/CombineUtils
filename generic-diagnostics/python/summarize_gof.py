...
def main():
    ...
    if vacuous:
        ...
        L.append("  * signal regions: data_obs is pseudo-data built from these")
        L.append("    same templates, with r and the rate parameters already")
        L.append("    applied, so the model can reproduce it to ~0.03%;")
