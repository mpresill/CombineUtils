...
combineTool.py -M Impacts -d ${inputCard}.root --expectSignal 1 --rMin -10 --doInitialFit -m 1 -n ${tag} --parallel 30  ${options5} ${ranges}${rateParamsRanges} 

combineTool.py -M Impacts -d ${inputCard}.root  --expectSignal 1 --rMin -10 --doFits -m 1 -n ${tag} --parallel 30 ${options5} ${ranges}${rateParamsRanges} 

combineTool.py -M Impacts -d ${inputCard}.root -m 1 -n ${tag} -o ${outputFolder}/impacts_${tag}.json --parallel 30

plotImpacts.py -i  ${outputFolder}/impacts_${tag}.json -o  impacts_${tag}_${Date} --summary
